...
import type UserClient, { TimeoutPeersOpts, TransactionProposalRequest } from './UserClient'
...
function addArgsOrArgBytesToTransactionRequest(
    transactionProposalRequest: TransactionProposalRequest,
    argsOrArgBytes?: Array<string> | Buffer
) {
    if (Buffer.isBuffer(argsOrArgBytes)) {
        transactionProposalRequest.argbytes = (argsOrArgBytes: any)
    } else {
        transactionProposalRequest.args = (argsOrArgBytes: any)
    }
    ...
    */
    query(
        ...
        return this.userClient.queryChaincode(
            this.channel,
            addArgsOrArgBytesToTransactionRequest(
                {
