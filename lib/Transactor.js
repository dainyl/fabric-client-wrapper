...
export default class Transactor {
    ...
    */
    query(
        ...
        return this.userClient.queryChaincode(this.channel, this.chaincodeId, target, {
            fcn,
            args,
            transientMap,
        })
    ...
    * @param {Map} [opts.transientMap] - Map that can be used by the chaincode but not saved in the ledger, such as cryptographic information for encryption
    * @param {Array<Peer>} [opts.waitPeers] - Peers to wait on, defaults to peers in channel
    * @param {number} [sendTransactionTimeout] - The maximum amount of time in ms to wait for a transaction
    ...
    */
    sendTransaction(
        ...
        return this.userClient.sendTransaction(this.channel, transactionId, transactionRequest, waitPeers, timeout)
    }
