...
export default class Transactor {
    ...
    */
    query(
        ...
        return this.userClient.queryChaincode(this.channel, {
    ...
    * @param {number} [waitTimeout] - The maximum amount of time in ms to wait for a transaction
    ...
    */
    sendTransactionProposal(fcn?: string, args?: Array<string>, transientMap?: Object) {
        return this.userClient.sendTransactionProposal(this.channel, {
            chaincodeId: this.chaincodeId,
            targets: this.endorsingPeers,
            fcn,
            args,
