...
import CouchDBKeyValueStore from 'fabric-client/lib/impl/CouchDBKeyValueStore'
 ...
 * @property {string} mspId - The MSP ID for the organization
...
/**
    ...
    @param mspId - The MSP ID for the organization
...
*/
export async function createFileKeyValueStoreOrganizationConfig(
    mspId: string,
...
/**
    ...
    @returns an object holding information about a organization
*/
export async function createCouchDBKeyValueStoreOrganizationConfig(
    mspId: string,
    url: string,
    dbName: ?string
): Promise<OrganizationConfig> {
