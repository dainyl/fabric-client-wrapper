...
import MultiUserClient from './MultiUserClient'
import { FcwPeer, EventHubPeer, FcwChannel } from './fabric-client-extended'
import createFabricCAClient from './createFabricCAClient'
import {
    createOrganizationConfig,
    createFileKeyValueStoreOrganizationConfig,
    createCouchDBKeyValueStoreOrganizationConfig,
} from './organization-config-factories'
import {
...
fcw.MultiUserClient = MultiUserClient
fcw.FcwPeer = FcwPeer
fcw.EventHubPeer = EventHubPeer
fcw.FcwChannel = FcwChannel
fcw.createFabricCAClient = createFabricCAClient
fcw.createOrganizationConfig = createOrganizationConfig
fcw.createFileKeyValueStoreOrganizationConfig = createFileKeyValueStoreOrganizationConfig
fcw.createCouchDBKeyValueStoreOrganizationConfig = createCouchDBKeyValueStoreOrganizationConfig
