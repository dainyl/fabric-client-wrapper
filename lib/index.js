...
import {
    ...
    newEventHubChannel,
    isEventHubChannel
} from "./fabric-client-extended/EventHubChannel"
import {
 ...
 */
fcw.setupChannel = (userClient, channelOrChannelName, opts) =>
    new ChannelSetup(userClient, channelOrChannelName, opts)

fcw.ChannelSetupClient = ChannelSetupClient
fcw.ChannelSetupServer = ChannelSetupServer
fcw.UserClient = UserClient
fcw.EventHubManager = EventHubManager
...
fcw.upgradeChannelToEventHubChannel = upgradeChannelToEventHubChannel
fcw.newEventHubChannel = newEventHubChannel
fcw.isEventHubChannel = isEventHubChannel
