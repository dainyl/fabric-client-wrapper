...
export function upgradePeerToFcwPeer(peer: Peer, { mspId, adminMspIds, role }: FcwPeerOpts) {
...
export function createFcwPeer({ requestUrl, peerOpts, mspId, adminMspIds, role }: CreateFcwPeerOpts) {
