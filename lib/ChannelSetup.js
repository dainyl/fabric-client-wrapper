...
export default class ChannelSetup {
    ...
    */
    withCreateChannel(createChannelOpts: CreateChannelOpts, swallowAlreadyCreatedErrors?: boolean): ChannelSetup {
    ...
    * @returns The ChannelSetup instance
    */
    withJoinChannel(joinChannelOpts?: JoinChannelOpts, swallowAlreadyCreatedErrors?: boolean): ChannelSetup {
