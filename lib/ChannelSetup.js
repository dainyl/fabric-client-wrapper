...
export default class ChannelSetup {
    ...
    withUpdateChannel(
        ...
        this.updateChannelOp = (channel: Channel) =>
            this.userClient
                .updateChannel(channel, updateChannelRequest)
                .then(response => response.wait(waitOpts))
        return this
    }
     ...
     * @param [opts] - Additional options
     * @param {number} [timeout] - The max amount of time the chaincode installing can take
     * @param {boolean} [swallowAlreadyCreatedErrors] - Option to swallow errors about chaincode being already installed. Overrides class level option
     * @returns The ChannelSetup instance
     */
