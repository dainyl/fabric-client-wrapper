...
* @param [silenceAlreadyCreatedErrors] - Option to swallow errors about channel being already created/joined or chaincode being installed/instantiated
*/
export default class ChannelSetup {
    userClient: UserClient
    channel: Channel
    silenceAlreadyCreatedErrors: boolean
    ...
    constructor(
        ...
        silenceAlreadyCreatedErrors: boolean = false
    ) {
        ...
        this.silenceAlreadyCreatedErrors = silenceAlreadyCreatedErrors
    }

    isSilenceAlreadyCreatedErrors(silenceAlreadyCreatedErrors?: boolean) {
        return typeof silenceAlreadyCreatedErrors !== 'undefined'
            ? silenceAlreadyCreatedErrors
            : this.silenceAlreadyCreatedErrors
    }
    ...
    * @param [silenceAlreadyCreatedErrors] - Option to swallow errors about channel being already created. Overrides class level option
    * @returns The ChannelSetup instance
    */
    withCreateChannel(createChannelOpts: CreateChannelOpts, silenceAlreadyCreatedErrors?: boolean): ChannelSetup {
        if (this.createChannelOp) {
            throw new Error('Cannot call createChannel more than once in a single setup')
        }

        if (this.isSilenceAlreadyCreatedErrors(silenceAlreadyCreatedErrors)) {
                ...
                channel
                    ...
                    .catch(error => {
                        ...
                        return this.userClient
                            .createChannel(channel, createChannelOpts)
    ...
    * @param [silenceAlreadyCreatedErrors] - Option to swallow errors about channel being already joined. Overrides class level option
    * @returns The ChannelSetup instance
    */
    withJoinChannel(joinChannelOpts?: JoinChannelOpts, silenceAlreadyCreatedErrors?: boolean): ChannelSetup {
        ...
        this.joinChannelOp = (channel: Channel, genesisBlock?: Object) =>
            this.userClient
                ...
                .catch(error => {
                    if (
                        !this.isSilenceAlreadyCreatedErrors(silenceAlreadyCreatedErrors) ||
                        !error.message ||
    ...
    * @param [silenceAlreadyCreatedErrors] - Option to swallow errors about chaincode being already installed. Overrides class level option
    * @returns The ChannelSetup instance
    */
            ...
            if (chaincodeInstallRequest.targets) {
                ...
                targets = channel
                    ...
                    .filter(
                        peer =>
                            !isFcwPeer(peer) ||
                            peer.getAdminMspIds().includes(this.userClient.getOrganizationConfig().mspId)
                    )
            }
            return this.userClient
                .installChaincode(
    ...
    * @param [silenceAlreadyCreatedErrors] - Option to swallow errors about chaincode being already instantiated. Overrides class level option
    * @returns The ChannelSetup instance
    */
    ...
    * @param [waitTransactionTimeout=60000] - A number indicating milliseconds to wait on the response before rejecting the promise with a timeout error. This overrides the default timeout of the Peer instance and the global timeout in the config settings.
    * @returns The ChannelSetup instance
    */
    withUpgradeChaincode(
        ...
        this.upgradeChaincodeOps.push(channel =>
            this.userClient
                .upgradeChaincode(channel, chaincodeUpgradeRequest, waitTransactionPeers, waitTransactionTimeout)
                .then(response => response.wait())
        )
        return this
    }
