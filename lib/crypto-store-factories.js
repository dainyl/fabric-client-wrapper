 ...
 */
export async function createFileKeyValueStoreAndCryptoSuite(keyValueStorePath: string): Promise<CryptoStore> {
 ...
 * @returns an object holding information about a organization
 */
export async function createCouchDBKeyValueStoreAndCryptoSuite(url: string, dbName: ?string): Promise<CryptoStore> {
