...
export default class MultiUserClient {
    ...
    async createChannel(
        ...
        return this.mainUserClient.createChannel(channel, createChannelRequest)
    }
    ...
    async joinChannel(
        ...
        this.userClients.forEach(userClient => {
            const ownedPeers = remove(peers, peer => peer.getAdminMspIds().includes(userClient.getMspId()))
        ...
        return {
            ...
            wait: (waitOpts?: Object) =>
                Promise.all(joinChannelResponses.map(joinChannelResponse => joinChannelResponse.wait(waitOpts))),
        }
    }
    ...
    instantiateChaincode(
        ...
        return this.mainUserClient.instantiateChaincode(channel, chaincodeInstantiateRequest, timeout)
    }
    ...
    upgradeChaincode(
        ...
        return this.mainUserClient.upgradeChaincode(channel, chaincodeUpgradeRequest, timeout)
    }
    ...
    async sendTransaction(
        ...
        return this.mainUserClient.sendTransaction(channel, transactionId, transactionRequest)
    }
    ...
    queryChaincode(
        ...
        return this.mainUserClient.queryChaincode(channel, queryChaincodeRequest, timeout)
    }
    ...
    async invokeChaincode(
        ...
        return this.mainUserClient.invokeChaincode(channel, transactionProposalRequest, timeout)
    }
}

export function isMultiUserClient(obj: any) {
    return obj.bindChannel && !obj.getMspId
}
