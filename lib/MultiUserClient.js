...
export default class MultiUserClient {
    ...
    */
    ...
    async sendTransaction(
        ...
        return this.mainUserClient.sendTransaction(channel, transactionId, transactionRequest, waitPeers, timeout)
    }
    ...
    queryChaincode(
        ...
        return this.mainUserClient.queryChaincode(channel, chaincodeId, target, opts)
    }
    ...
    async invokeChaincode(
        ...
        return this.mainUserClient.invokeChaincode(
            channel,
            chaincodeId,
            targets,
            opts,
